...
<head>
    ...
    <title>Polo de chándal de réplica de Red Bull Racing X Hypebeast</title>
            ...
            <div class="container-product">
                ...
                <div class="product-layout">
                    <div class="product-image">
                        <img src="img/ul2.jpg" alt="Polo de chándal de réplica de Red Bull Racing X Hypebeast<" class="main-product-img"> 
                    </div>
                    ...
                    <div class="product-info">
                        <form method="POST" action="agregarCarrito.php">
                            ...
                            <h1 class="product-title">Polo de chándal de réplica de Red Bull Racing X Hypebeast</h1>
                            <p class="product-price">137,00 US$</p>
                ...
                <section class="product-description-section">
                    ...
                    <div class="description-content">
                        <p>Equipación esencial, un estilo fresco. Descubre la Chamarra de Lluvia Red Bull X HYPEBEAST:
