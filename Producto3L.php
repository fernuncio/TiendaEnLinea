...
<head>
    ...
    <title>Sudadera con capucha extragrande McLaren New Era Worldmark - Negra</title>
            ...
            <div class="container-product">
                ...
                <div class="product-layout">
                    <div class="product-image">
                        <img src="img/ul3.jpg" alt="Polo de chándal de réplica de Red Bull Racing X Hypebeast<" class="main-product-img"> 
                    </div>
                    ...
                    <div class="product-info">
                        <form method="POST" action="agregarCarrito.php">
                            ...
                            <h1 class="product-title">Sudadera con capucha extragrande McLaren New Era Worldmark - Negra</h1>
                            <p class="product-price">108,00 US$</p>
